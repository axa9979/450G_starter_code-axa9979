    ...
    implements TableRenderer
{
    ...
    public TextTableRenderer(TextTable textTable)
    {
        ...
        tableModel = textTable.getTableModel();
    }
    ...
    public void render(OutputStream os, int indent)
    {
        ...
        String indexFormat1 = (new StringBuilder()).append("%1$-").append(rowCountStrSize).append("s  ").toString();
        String indexFormat2 = (new StringBuilder()).append("%1$").append(rowCountStrSize).append("s. ").toString();
        ...
        for(int j = 0; j < tableModel.getColumnCount(); j++)
            ps.printf(formats[j], new Object[] {
        ...
        for(int i = 0; i < tableModel.getRowCount(); i++)
        {
            ...
            if(textTable.addRowNumbering)
                if(!modelAllowsNumberingAt(i))
                    ...
                    ps.printf(indexFormat2, new Object[] {
                        Integer.valueOf(i + 1)
                    });
            for(int j = 0; j < tableModel.getColumnCount(); j++)
    ...
    protected void printValue(PrintStream ps, int row, int col, boolean empty)
    {
        ...
        ps.printf(formats[col], new Object[] {
            value
        });
    }
    ...
    {
        if(textTable.addRowNumbering)
            ps.printf(indexFormat1, new Object[] {
                ""
            });
    }
